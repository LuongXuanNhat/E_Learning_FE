...
import {
  deleteUser,
  fetchSecretaryDepartmentPersonal,
...
function EmployeeSecretary() {
  ...
  useEffect(() => {
    const loadUsers = async () => {
      try {
        const data = await fetchSecretaryDepartmentPersonal();
        setUsers(data);
...
export default MiddlewareAuthor(EmployeeSecretary, [Position.HEAD_EDUCATION]);
