...
export default function RegisterClass() {
  ...
  useEffect(() => {
    const loadClasses = async () => {
      try {
        const data = await fetchClassRegisterForAdmin();
        setClases(data);
        ...
        <tbody>
          {currentClasses.map((classes) => (
            <tr key={classes.class_id}>
              ...
              <td className="p-4 border-b border-blue-gray-50">
                <p className="block text-blue-600 font-sans text-sm antialiased font-normal leading-normal">
              ...
              <td className="p-4 border-b border-blue-gray-50 flex justify-around">
                ...
                <a
                  href={`/quan-ly-lop-hoc/${classes.class_id}`}
                  className="block font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900"
                >
                  <Button color="amber" className="capitalize ml-2">
                    Chỉnh sửa
                  </Button>
                </a>
                <Button
                  ...
                  onClick={() => deleteConfirm(classes.class_id)}
                >
                  Xóa
                </Button>
              </td>
